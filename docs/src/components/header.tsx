        ...
        <nav className="hidden lg:flex items-center gap-1 text-[15px] font-medium text-[#ebecf0]">
          ...
          <div className="flex items-center gap-2 ml-2 pl-4 border-l border-[#343a46]">
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-[#149eca] focus:ring-offset-2 focus:ring-offset-[#23272f] ${useGeez ? 'bg-[#149eca]' : 'bg-[#343a46]'
                }`}
              role="switch"
            ...
            >
              <span
                className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform duration-300 shadow-sm ${useGeez ? 'translate-x-6' : 'translate-x-1'
                  }`}
              />
            </button>
            <span className={`text-xs font-medium transition-colors ${!useGeez ? 'text-[#f6f7f9]' : 'text-[#5e6677]'}`}>
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    type="button"
                    onClick={() => setMode(useGeez ? 'latin' : 'geez')}
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-[#149eca] ${useGeez ? 'bg-[#149eca]' : 'bg-[#343a46]'
                      }`}
                    role="switch"
                    aria-checked={useGeez}
                  >
